...
func writeAutomatedAcceptanceRecord(options acceptanceOptions, recordedAt time.Time) error {
	...
	fmt.Fprintln(&record, "| Codex Live Acceptance | Not required | ADR-0010 root-runtime package and public-seam scope; no live VPS evidence claimed |")
	fmt.Fprintln(&record, "| Owner Acceptance | Not required | ADR-0010 root-runtime package and public-seam scope; no maintained-client evidence claimed |")
	fmt.Fprintln(&record)
	fmt.Fprintln(&record, "Integrated Ubuntu Verification: Not required - ADR-0010 root-runtime package and public-seam scope; no automated Ubuntu integration evidence claimed.")
