...
func buildInstallWith(ctx context.Context, request softwareubuntu.InstallHandoffRequest, dependencies installBuildDependencies) (*builtInstall, error) {
	...
	http01, ok := httpNetwork.HTTP01Contribution()
	if !ok {
