...
go test ./internal/installation -run '^TestInstallation(InterfaceOwnsPartialDraftUntilDiscard|InterfaceCancellationBeforeApplyDiscardsDraftAndApproval|ReviewOwnsFirstDraftDefaultsAndProgression|ReviewGuidesUnprovedAndAmbiguousNetworkFacts|ReviewDerivesAndImmediatelyChecksOneRealityHostname|ReviewShowsEveryExplicitPortReplacementInThePlan|ReviewKeepsTheRunningReleaseReadOnlyAfterCandidateFailure|ReviewSuppliesDomainHelpAndRejectsItsExample|ReviewGuidesEveryNonCloudflareFieldAndRejectsTutorialValues)$' -count=1
go test ./internal/ownerconsole -run '^TestRun(ShowsReadOnlyInstallationFactsAndDetectedPublicIPv4|ShowsTheSameCompleteDomainHelpAtExactTerminalSizes|ShowsEveryInstallationHelpSourceAtExactTerminalSizes|FieldChangeClearsEditingStateThroughThePublicOutcome)$' -count=1
